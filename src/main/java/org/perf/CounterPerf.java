...
public class CounterPerf extends ReceiverAdapter {
   ...
   @Property
   protected boolean print_incrementers;
   @Property
   ...
   static {
      try {
         ...
         PerfUtil.init();
         ClassConfigurator.add((short) 1050, IncrementResult.class);
      } catch (Exception e) {
   ...
   protected class Incrementer implements Runnable {
      ...
      public AverageMinMax avgIncrementTime() {
         return avg_incrtime;
      }
   ...
   protected static class IncrementResult implements Streamable {
      ...
      public String toString() {
         ...
         return String.format("%,.2f increments/sec (%,d increments, %s / increment)",
               ...
               Util.printTime((long) avg_increments.average(), TimeUnit.NANOSECONDS));
      }
   }
