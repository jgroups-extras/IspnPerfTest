...
CONFIG="-Dtangosol.coherence.cacheconfig=conf/coh.xml"

java -classpath $CP -Dproc_id=${proc_id} $CONFIG $DEBUG $LOG $JG_FLAGS $FLAGS $EXPERIMENTAL $JMX $JMC $GC_FLAGS org.perf.CohTest $*
